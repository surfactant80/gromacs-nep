                                                   ...
                                                   const SimulationWorkload& simulationWork)
{
    ...
    const bool haveNonProviderSpecialForces =
            (inputrec.bPull && pull_have_potential(*pull_work))
            || inputrec.bDoAwh || inputrec.bRot || (ed != nullptr) || inputrec.bIMD;
    domainWork.haveDeviceForceProviders =
            fr.forceProviders->allForceProvidersSupportDeviceForces()
            && !haveNonProviderSpecialForces
    ...
    domainWork.haveCpuLocalForceWork =
            (domainWork.haveSpecialForces && !domainWork.haveDeviceForceProviders)
