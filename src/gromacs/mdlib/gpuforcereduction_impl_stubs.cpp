...
void GpuForceReduction::registerSecondRvecForce(DeviceBuffer<gmx::RVec> /* forcePtr */)
{
    GMX_THROW(gmx::NotImplementedError(
            "A GPU force reduction function was called in a build without supported GPUs."));
}
