...
public:
    ...
    /*! \brief Register a second rvec-format force to be reduced.
     *
     * Used by device-capable external force providers such as full-system NEP.
     */
    void registerSecondRvecForce(DeviceBuffer<RVec> forcePtr);
